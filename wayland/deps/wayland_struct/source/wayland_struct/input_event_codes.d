module wayland_struct.input_event_codes;
//  libphobos/libdruntime/core/sys/linux/input_event_codes.d
...
enum KEY_PROG3            = 202;
enum KEY_PROG4            = 203;
enum KEY_ALL_APPLICATIONS = 204; /* AC Desktop Show All Applications */
enum KEY_DASHBOARD        = KEY_ALL_APPLICATIONS;
...
enum KEY_FULL_SCREEN              = 0x174;   /* AC View Toggle */
enum KEY_ZOOM                     = KEY_FULL_SCREEN;
enum KEY_MODE                     = 0x175;
enum KEY_KEYBOARD                 = 0x176;
enum KEY_ASPECT_RATIO             = 0x177;   /* HUTRR37: Aspect */
enum KEY_SCREEN                   = KEY_ASPECT_RATIO;
...
enum KEY_NOTIFICATION_CENTER      = 0x1bc;   /* Show/hide the notification center */
enum KEY_PICKUP_PHONE             = 0x1bd;   /* Answer incoming call */
enum KEY_HANGUP_PHONE             = 0x1be;   /* Decline incoming call */
...
enum KEY_ROTATE_LOCK_TOGGLE       = 0x231;   /* Display rotation lock */
...
enum KEY_ASSISTANT                = 0x247;   /* AL Context-aware desktop assistant */
enum KEY_KBD_LAYOUT_NEXT          = 0x248;   /* AC Next Keyboard Layout Select */
enum KEY_EMOJI_PICKER             = 0x249;   /* Show/hide emoji picker (HUTRR101) */
enum KEY_DICTATE                  = 0x24a;   /* Start or Stop Voice Dictation Session (HUTRR99) */
...
enum KEY_PRIVACY_SCREEN_TOGGLE    = 0x279;

/* Select an area of screen to be copied */
enum KEY_SELECTIVE_SCREENSHOT     = 0x27a;

/* Move the focus to the next or previous user controllable element within a UI container */
enum KEY_NEXT_ELEMENT             = 0x27b;
enum KEY_PREVIOUS_ELEMENT         = 0x27c;

/* Toggle Autopilot engagement */
enum KEY_AUTOPILOT_ENGAGE_TOGGLE  = 0x27d;

/* Shortcut Keys */
enum KEY_MARK_WAYPOINT            = 0x27e;
enum KEY_SOS                      = 0x27f;
enum KEY_NAV_CHART                = 0x280;
enum KEY_FISHING_CHART            = 0x281;
enum KEY_SINGLE_RANGE_RADAR       = 0x282;
enum KEY_DUAL_RANGE_RADAR         = 0x283;
enum KEY_RADAR_OVERLAY            = 0x284;
enum KEY_TRADITIONAL_SONAR        = 0x285;
enum KEY_CLEARVU_SONAR            = 0x286;
enum KEY_SIDEVU_SONAR             = 0x287;
enum KEY_NAV_INFO                 = 0x288;
enum KEY_BRIGHTNESS_MENU          = 0x289;
 ...
 */
enum KEY_MACRO1           = 0x290;
enum KEY_MACRO2           = 0x291;
enum KEY_MACRO3           = 0x292;
enum KEY_MACRO4           = 0x293;
enum KEY_MACRO5           = 0x294;
enum KEY_MACRO6           = 0x295;
enum KEY_MACRO7           = 0x296;
enum KEY_MACRO8           = 0x297;
enum KEY_MACRO9           = 0x298;
enum KEY_MACRO10          = 0x299;
enum KEY_MACRO11          = 0x29a;
enum KEY_MACRO12          = 0x29b;
enum KEY_MACRO13          = 0x29c;
enum KEY_MACRO14          = 0x29d;
enum KEY_MACRO15          = 0x29e;
enum KEY_MACRO16          = 0x29f;
enum KEY_MACRO17          = 0x2a0;
enum KEY_MACRO18          = 0x2a1;
enum KEY_MACRO19          = 0x2a2;
enum KEY_MACRO20          = 0x2a3;
enum KEY_MACRO21          = 0x2a4;
enum KEY_MACRO22          = 0x2a5;
enum KEY_MACRO23          = 0x2a6;
enum KEY_MACRO24          = 0x2a7;
enum KEY_MACRO25          = 0x2a8;
enum KEY_MACRO26          = 0x2a9;
enum KEY_MACRO27          = 0x2aa;
enum KEY_MACRO28          = 0x2ab;
enum KEY_MACRO29          = 0x2ac;
enum KEY_MACRO30          = 0x2ad;
 ...
 */
enum KEY_MACRO_RECORD_START = 0x2b0;
enum KEY_MACRO_RECORD_STOP  = 0x2b1;
enum KEY_MACRO_PRESET_CYCLE = 0x2b2;
enum KEY_MACRO_PRESET1      = 0x2b3;
enum KEY_MACRO_PRESET2      = 0x2b4;
enum KEY_MACRO_PRESET3      = 0x2b5;
 ...
 */
enum KEY_KBD_LCD_MENU1        = 0x2b8;
enum KEY_KBD_LCD_MENU2        = 0x2b9;
enum KEY_KBD_LCD_MENU3        = 0x2ba;
enum KEY_KBD_LCD_MENU4        = 0x2bb;
enum KEY_KBD_LCD_MENU5        = 0x2bc;
 ...
 */
enum REL_RESERVED      = 0x0a;
enum REL_WHEEL_HI_RES  = 0x0b;
enum REL_HWHEEL_HI_RES = 0x0c;
enum REL_MAX           = 0x0f;
...
enum SW_MACHINE_COVER        = 0x10;  /* set = cover closed */
enum SW_MAX                  = 0x10;
